        ...
        <div class="row">
          ...
          <div class="col l4 m4 s12 minimargin">
            <img class="pointer responsive-img" src="static/img/coding/mantro.png" 
              onclick="showModal(
                'Mantro', 
                '<b>Description:</b> After a deep conversation with a friend about mindfulness, he recommended I read The Untethered Soul, a book about witnessing thoughts without attachment to find true and lasting happiness. While I really wanted to read the book, I knew that I would probably buy it and start it but eventually get busy and never finish it. I thought it would be great if there was a way to get the key insights from the book without having to read the whole thing, so I asked ChatGPT to summarize the key lessons of the book for me. I then had the idea to do this for any book, so I built Mantro, an app that summarizes books and lets you interact with the author. I used the Google Books API to scrape books then fed them to an LLM to generate a summary. I then added a feature where you can ask the author questions and the LLM will generate a response as if the author was responding. I have used this app to summarize many books and also get recommendations, including The Untethered Soul, Meditations by Marcus Aurelius, and more. I added several more features such as book collections, summarizing multiple books at once, and searching books by topic. I will make you an account if you want to try this app to please feel free to shoot me an email if you are interested!',
        ...
        <div class="row" style="margin-top: 50px !important">
          ...
          <div class="col l4 m4 s12 minimargin">
            <img class="pointer responsive-img" src="static/img/coding/lectura.png" 
              onclick="showModal(
                'Lectura', 
                '<b>Description:</b> ChatGPT is great to learn about topics at a high level, but to really get deep, you have to ask many follow-up questions. The best way to learn about a topic in detail is still to take a course on it, but courses are expensive and time-consuming. I built Lectura to solve this problem. Lectura is an app that uses AI to generate course notes for any subject. You can enter a topic and Lectura will generate a list of the most important concepts in that topic. You can then click on any concept to get detailed lecture notes for that concept. I have used Lectura to learn about many topics I find interesting, including Buddhism, brand strategy, string theory, and the history of the Roman Empire. I also experimented with ways to test whether the user is actually retaining what they are reading and added a feature where you can click on any bullet point which blurs it and asks you to type it from memory. You must rewrite the bullet point from memory in your own words and then a custom OpenAI function checks your input for sufficient understanding. I have found this to be a great way to force yourself to retain what you are reading. This is one of my favorite projects so far, and I have several future directions in mind for it. I encourage you to give it a try and hope you find it useful!', 
          ...
          <div class="col l4 m4 s12 minimargin">
            <img class="pointer responsive-img" src="static/img/coding/infinito.png" 
              onclick="showModal(
                'Infinito', 
                '<b>Description:</b> This project was inspired by The Infinite Conversation, an AI generated, never-ending discussion between Werner Herzog and Slavoj Žižek. My twist on it was to create a conversation between two LLMs with a focus on interesting and controversial conversation topics. I also experimented with a few different text-to-speech technologies, trying the built-in web package which was robotic, Amazon Polly which was slow, and ElevenLabs which was perfect (despite being a bit expensive). My prompt for both sides of the conversation after some experimentation is: <br><br><i>Continue only the next line (not more than one) of this conversation in the most engaging way possible for a third-party listener of the conversation who loves hearing lively debates, friendly banter, interesting stories, and learning new things. Do not let the conversation end and do not say bye; suggest a change of topic instead if the conversation is in a lull.</i>', 
